    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700">
            <h2 class="text-2xl font-bold text-white">
                <i class="fas fa-plus-circle mr-2"></i>Add New Server
            </h2>
        </div>

        <form action="<?= site_url('servers/store') ?>" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="certificate_path" id="certificate_path" required
                           value="<?= old('certificate_path') ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           placeholder="e.g., /etc/apache2/ssl">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="apache_restart_command" id="apache_restart_command"
                           value="<?= old('apache_restart_command', 'sudo systemctl restart apache2') ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           placeholder="sudo systemctl restart apache2">
                    <p class="text-xs text-gray-500 mt-1">Command to restart Apache on the server</p>
                </div>
            </div>
            ...
            <div class="flex justify-end space-x-3 pt-4 border-t">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Add Server
                </button>
            </div>
        </form>
    </div>
