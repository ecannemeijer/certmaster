        ...
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button onclick="clearLogsSearch()" class="px-3 py-2 bg-gray-300 hover:bg-gray-400 text-gray-700 rounded-lg text-sm transition">
...
const logsGridApi = agGrid.createGrid(document.getElementById('logsGrid'), logsGridOptions);

// Logs search functionality
const logsSearchInput = document.getElementById('logsSearchInput');
logsSearchInput.addEventListener('keyup', (e) => {
    logsGridApi.setGridOption('quickFilterText', e.target.value);
});

function clearLogsSearch() {
    logsSearchInput.value = '';
    logsGridApi.setGridOption('quickFilterText', '');
}
</script>
